...
[^7]:. Maggini S, Alaman M, Wintergerst E. B-vitamins and cognitive function - what is the evidence? Nutricion Hospitalaria 2014;30:74-81.
...
La principal fuente de B1 en la alimentación se obtiene de carnes, vegetales, granos enteros y legumbres[^10]. 

![Captura de pantalla 2024-11-20 151330.png](../_resources/Captura%20de%20pantalla%202024-11-20%20151330.png)[^10]
...
En adultos la deficiencia de tiamina B1 está relacionada con el consumo excesivo de alcohol, la tiamina es un cofactor fundamental para las enzimas encargadas del metabolismo en células cerebrales resultando en una disminución de la función sináptica[^10][^11]. En los pacientes graves la suplementación se administra por inyecciones intravenosas o intramusculares en altas cantidades por periodos establecidos[^11][^12].  
...
Una posible aplicación de la tiamina es en mujeres cursando el síndrome premenstrual, ayudando a disminuir la sintomatología. Se cree que el síndrome premenstrual se produce por una alteración en los niveles de serotonina, dopamina, ácidos grasos y en la actividad de la aldosterona, todo esto provoca una sintomatología que abarca tanto un aspecto conductual como cambios bruscos de humor, depresión y tensión, así como uno físico que incluye síntomas como dolor intestinal, fatiga, bochornos y mareos. La relación que existe entre la tiamina y la disminución de los síntomas no está bien dilucidada, pero puede deberse a su participación en el metabolismo cerebral[^13]. 
...
El rol más importante de la tiamina se da en el desarrollo del feto hasta el desarrollo del infante, es decir, es un pilar fundamental durante el crecimiento de los niños hasta que ya hayan alcanzado la maduración del cuerpo. El sistema nervioso central contempla el 20% del metabolismo neto del cuerpo y durante su desarrollo la participación de la tiamina es fundamental[^14]. Una deficiencia de esta vitamina puede culminar en deficiencias neurológicas graves[^15][^16].  
...
En la infancia la obtención de vitamina B2 de la dieta es fundamental en el desarrollo del cerebro.[^10]  
...
La biotina se utiliza popularmente para mantención saludable de la piel, pelo y uñas tanto en niños, adolescentes y adultos, esto se debe a su participación en la síntesis de queratina[^41]. Pero a parte de esta función la biotina tiene un rol fundamental como cofactor de múltiples vías metabólicas como lo es la glucogénesis, síntesis de ácidos grasos y catabolismo de aminoácidos[^42]. Su efectividad se refleja principalmente pacientes que tengan algún grado de deficiencia de esta vitamina, ya sea por una causa hereditaria o adquirida, como puede pasar con pacientes que estén con tratamientos anticonvulsivos con ácido valproico, prolongado uso de antibióticos, uso de isotretinoina, alcoholismo y mujeres embarazadas[^43][^44]. Sin embargo, no se ha visto un mayor beneficio en personas sanas reportado por los estudios publicados hasta la fecha[^41]. 
...
Su fuente alimenticia proviene principalmente de alimentos como legumbres, lentejas, vegetales de hoja verde y limones[^10].


![Captura de pantalla 2024-11-20 153711.png](../_resources/Captura%20de%20pantalla%202024-11-20%20153711.png)
[^10]
El ácido fólico cumple un papel importante en la división celular por lo que es fundamental en el desarrollo embrionario[^45]. Múltiples estudios han reportado que la deficiencia de ácido fólico en el embarazo puede provocar malformaciones en el tubo neural, el corazón y la zona craneofacial[^46][^47].  
...
Para mujeres con un ciclo menstrual ya iniciado y con un perfil fisiológico propenso o que ya haya presentado un cuadro anémico, se recomienda la suplementación con ácido fólico en conjunto a hierro elemental para reducir la incidencia de anemia y defectos del tubo neural (del cual se desarrolla todo el sistema nervioso central en el desarrollo del feto) en el embarazo. Las recomendaciones específicas deben ser indicadas por un médico ya que una dosis mayor a lo indicado puede incidir en el desarrollo del infante; estudios recientes han expuesto que una dosis excesiva de ácido fólico en el embarazo puede afectar el desarrollo cerebral, la función metabólica y la respuesta alérgica, también se ha encontrado una relación respecto al aumento de probabilidades de asma en etapas posteriores de la vida del infante.[^48] 
...
the Essential Medicines list to accelerate anemia and neural tube defects reduction. Advances in Nutrition, 12(2), 334–342. https://doi.org/10.1093/advances/nmaa169 

Se ha observado que en personas fumadoras los niveles de folato en sangre disminuyen, lo cual se ha asociado a un incremento en la accion oxidativa del tabaco. Estudios realizados sobre un grupo de pacientes con alto riesgo cardiovascular evaluaron la eficacia del tratamiento coadyuvante de ácido fólico (0.8 mg/día) en su tratamiento base con enalapril, se realizaron pruebas respecto al riesgo de primer infarto sobre pacientes fumadores, exfumadores y no fumadores resultando en una diminución general del riesgo de infarto. En el estudio se concluyó que para fumadores activos y exfumadores el requerimiento de ácido fólico es mayor, pero no se propuso una dosis optima.[^49]
...
Su fuente nutricional proviene principalmente de pescados, carnes y productos lácteos. [^10]
